      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="text-xl font-display font-bold">DineEase</h3>
            <p className="text-gray-300">
              Your trusted platform for restaurant reservations and reviews.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/reservations" className="text-gray-300 hover:text-primary transition-colors">
                  My Reservations
                </Link>
              </li>
              <li>
